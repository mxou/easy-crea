...
--
-- Hôte : 127.0.0.1
-- Généré le : ven. 18 oct. 2024 à 01:46
...
INSERT INTO `carte` (`id_carte`, `texte_carte`, `date_soumission`, `ordre_soumission`, `choix1_population`, `choix1_finances`, `choix2_population`, `choix2_finances`) VALUES
(1, 'zadiuazdoiauhoih', '2024-10-14', 1, -4, 2, 2, -1),
(2, 'Une paysanne addict au fentanyl propose un coup d\'etat contre le menuisier', '2024-10-14', 2, -2, 2, -1, 2),
(3, 'Test creer une carte et tout la genre wow', '2024-10-14', 3, -100, 200, 200, -100),
(4, 'Lil young pandillas, empereur du venezuela viens proposer une alliance', '2024-10-14', 4, 8, 2, 1, 0),
(5, 'La météo est clémente, les récoltes sont très bonne mais il faut plus de gueux pour les récolter', '2024-10-14', 5, -2, 5, 1, 1),
(6, 'Le japon souhaite se venger de pearl harbor, on est carrément pas concernés mais askip peut importe le choix on va mourir', '2024-10-15', 6, -100, -100, -99, -99),
(7, 'Un homme se prétends ancien aventurier, il a mis fin a sa carrière suite a une flèche dans le genou. Il se dit désormais bac +4 spé trésorier', '2024-10-15', 7, 1, 5, 0, 1),
(8, 'HAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA', '2024-10-17', 8, -5, 2, 4, -3);
...
--
ALTER TABLE `createur`
  MODIFY `id_createur` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT pour la table `deck`
--
ALTER TABLE `deck`
  MODIFY `id_deck` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
COMMIT;
